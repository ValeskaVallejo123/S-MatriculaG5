    ...
    <div class="card border-0 shadow-sm mb-4"
        ...
        <div class="card-body p-4">
            <div class="d-flex align-items-start gap-3">
                <div style="width:50px; height:50px; background: linear-gradient(135deg,#00508f,#003b73);
                ...
                <div>
                    ...
                    <p class="text-muted mb-0" style="font-size:0.9rem;">
                        Este sistema utiliza un modelo de permisos basado en roles. Cada usuario tiene asignado
                        un rol que determina sus capacidades dentro del sistema.
                    </p>
                </div>
            </div>
        </div>
    ...
    <div class="row g-4 mb-4">
        ...
        <div class="col-lg-6">
            <div class="card border-0 shadow-sm h-100"
                 style="border-radius:12px; border:2px solid #fca5a5 !important; overflow:hidden;">
                ...
                <div class="card-body p-4">
                            ...
                            <ul class="list-unstyled mb-0">
                                <li class="d-flex align-items-start gap-2 mb-2">
                                    ...
                                    <span class="text-muted" style="font-size:0.9rem;">
                                        Acceso completo a <strong>todas las funciones</strong> del sistema
                                    </span>
                                </li>
                                <li class="d-flex align-items-start gap-2 mb-2">
                                    <i class="fas fa-check-circle text-success mt-1 flex-shrink-0"></i>
                                    <span class="text-muted" style="font-size:0.9rem;">
                                        Puede <strong>crear, editar y eliminar administradores</strong>
                                    </span>
                                </li>
                                <li class="d-flex align-items-start gap-2 mb-2">
                                    <i class="fas fa-check-circle text-success mt-1 flex-shrink-0"></i>
                                    <span class="text-muted" style="font-size:0.9rem;">
                                        Asigna y modifica <strong>permisos de otros usuarios</strong>
                                    </span>
                                </li>
                                <li class="d-flex align-items-start gap-2 mb-2">
                                    <i class="fas fa-check-circle text-success mt-1 flex-shrink-0"></i>
                                    <span class="text-muted" style="font-size:0.9rem;">
                                        Acceso a <strong>configuración del sistema</strong>
                                    </span>
                                </li>
                                <li class="d-flex align-items-start gap-2 mb-2">
                                    <i class="fas fa-check-circle text-success mt-1 flex-shrink-0"></i>
                                    <span class="text-muted" style="font-size:0.9rem;">
                                        Gestiona <strong>periodos académicos y cupos</strong>
                                    </span>
                                </li>
                                <li class="d-flex align-items-start gap-2 mb-0">
                                    <i class="fas fa-check-circle text-success mt-1 flex-shrink-0"></i>
                                    <span class="text-muted" style="font-size:0.9rem;">
                                        Visualiza <strong>todas las estadísticas y reportes</strong>
                                    </span>
                                </li>
                            </ul>
                        </div>
                    ...
                    <div class="alert border-0 mb-0"
                         style="background:rgba(239,68,68,0.08); border-left:4px solid #ef4444 !important; border-radius:8px;">
                        <div class="d-flex align-items-start gap-2">
                            ...
                            <div>
                                ...
                                <p class="text-danger mb-0" style="font-size:0.8rem; opacity:0.85;">
                                    Este rol debe ser asignado solo a usuarios de máxima confianza,
                                    ya que tiene control total sobre el sistema.
                                </p>
                            </div>
                        </div>
                    </div>
        ...
        <div class="col-lg-6">
            <div class="card border-0 shadow-sm h-100"
                 style="border-radius:12px; border:2px solid #93c5fd !important; overflow:hidden;">

                <div class="card-header border-0 py-4 px-4"
                     style="background: linear-gradient(135deg,#00508f 0%,#4ec7d2 100%);">
                    <div class="d-flex align-items-center justify-content-between">
                        <div class="d-flex align-items-center gap-3">
                            <div style="width:50px; height:50px; background:white; border-radius:10px;
                                        display:flex; align-items:center; justify-content:center;
                ...
                <div class="card-body p-4">
                    ...
                    <div class="card border-0 mb-3" style="background:#f9fafb; border-radius:10px;">
                        <div class="card-body p-3">
                            ...
                            <p class="text-muted mb-3" style="font-size:0.8rem;">
                                El Super Admin puede asignar los siguientes permisos:
                            </p>
                    ...
                    {{-- Restricciones --}}
                    <div class="alert border-0 mb-0"
                         style="background:rgba(245,158,11,0.08); border-left:4px solid #f59e0b !important; border-radius:8px;">
                        <div class="d-flex align-items-start gap-2">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <span class="badge"
                                      style="background:rgba(0,80,143,0.1); color:#00508f; font-size:0.75rem;">
                                    Configurable
                                </span>
                            </td>
                        </tr>
