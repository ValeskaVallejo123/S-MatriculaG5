...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .hexagon-pattern { position: absolute; width: 100%; height: 100%; opacity: .15; }

        .hex {
            position: absolute; background: #4ec7d2;
        ...
        .left-content p  { font-size: 1rem; opacity: .95; color: #bfd9ea; text-shadow: 0 2px 10px rgba(0,0,0,.2); }
        ...
        .form-container {
            ...
            animation: slideIn .8s ease-out; padding: 10px 0;
        }
        ...
        .form-header p  { color: #00508f; font-size: .85rem; line-height: 1.5; }
        ...
        /* Icono toggle mostrar/ocultar contraseña */
        .toggle-password {
        ...
        .toggle-password:hover { color: #4ec7d2; }
        ...
        .strength-text { font-size: .72rem; color: #94a3b8; font-weight: 500; }
