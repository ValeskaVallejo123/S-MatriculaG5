            ...
            <div class="card-body p-3">
                <form action="{{ route('observaciones.update', $observacion->id) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <label class="form-label fw-semibold small mb-1">Estudiante</label>
                        <select name="estudiante_id" class="form-select form-select-sm @error('estudiante_id') is-invalid @enderror">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="descripcion" rows="4"
                                  ...
                                  style="resize: none;">{{ $observacion->descripcion }}</textarea>
                        @error('descripcion')
                            <div class="invalid-feedback small">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="d-flex gap-2 pt-2 border-top">
                        <button type="submit" class="btn btn-sm fw-semibold flex-fill"
                                style="background: linear-gradient(135deg, #4ec7d2 0%, #00508f 100%); color: white; border: none; padding: 0.6rem; border-radius: 8px;">
