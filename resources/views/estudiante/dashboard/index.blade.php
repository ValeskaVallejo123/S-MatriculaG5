...
@push('styles')
    <style>
        /* ESTO CORRIGE LA PANTALLA CORTADA */
        /* Eliminamos el margen izquierdo que el layout reserva para el sidebar */
...
@section('content')
    ...
    {{-- Agregamos un contenedor con max-width para que no se pegue demasiado a los bordes en pantallas gigantes --}}
