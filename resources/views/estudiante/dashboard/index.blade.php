...
@section('content')
    <div class="container" style="max-width: 1200px;">
        ...
        <!-- Enlace a Estado de Solicitud -->
        <div class="mb-4">
            <a href="{{ route('estado-solicitud') }}" class="btn btn-sm fw-semibold" style="background: #00508f; color: white; border-radius: 8px; padding: 0.5rem 1rem; text-decoration: none;">
                <i class="fas fa-question-circle me-2"></i> Estado de Solicitud
            </a>
        </div>
