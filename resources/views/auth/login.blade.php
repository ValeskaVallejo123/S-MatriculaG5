...
<div class="right-section">
    <div class="login-container">
        ...
        {{-- Manejo de errores de validación, usando la directiva @error de Blade --}}
        @if ($errors->any())
        ...
        {{-- Manejo de mensajes de estado (ej: después de cerrar sesión o resetear contraseña) --}}
        @if (session('status'))
        ...
        <form method="POST" action="{{ route('login') }}" id="loginForm">
            ...
            <div class="remember-forgot">
                ...
                {{-- Enlace de Recuperación de Contraseña usando tu ruta con nombre --}}
        ...
        <div class="register-link">
            ...
            @else
                {{-- Ruta alternativa si no se usa el paquete de registro de Laravel (Breeze/Jetstream) --}}
...
<script>
    // JS para manejar el estado de carga del botón al enviar el formulario
    ...
    // JS para limpiar visualmente los mensajes de error al empezar a escribir
