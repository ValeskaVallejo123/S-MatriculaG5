            ...
            <div class="card-body p-3">
                <div class="d-flex align-items-center">
                    <div class="icon-box me-3" style="width: 45px; height: 45px; background: rgba(78, 199, 210, 0.3); border-radius: 10px; display: flex; align-items: center; justify-content: center;">
                        <i class="fas fa-calendar-plus text-white" style="font-size: 1.3rem;"></i>
                    </div>
                    <div class="text-white">
                        <h5 class="mb-0 fw-bold" style="font-size: 1.1rem;">Registrar Período Académico</h5>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="position-relative">
                                    ...
                                    <select name="tipo"
                                        ...
                                        <option value="clases" {{ old('tipo') == 'clases' ? 'selected' : '' }}>Clases</option>
                                        <option value="vacaciones" {{ old('tipo') == 'vacaciones' ? 'selected' : '' }}>Vacaciones</option>
                                        <option value="examenes" {{ old('tipo') == 'examenes' ? 'selected' : '' }}>Exámenes</option>
                                    </select>
                                    @error('tipo')
                                    <div class="invalid-feedback" style="font-size: 0.8rem;">
                                        <i class="fas fa-exclamation-circle me-1"></i>{{ $message }}
