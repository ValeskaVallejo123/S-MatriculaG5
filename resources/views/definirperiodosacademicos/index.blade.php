...
@section('topbar-actions')
    <a href="{{ route('periodos-academicos.create') }}"
       style="background: white; color: #00508f; padding: 0.45rem 1rem; border-radius: 8px; text-decoration: none; font-weight: 600; display: inline-flex; align-items: center; gap: 0.5rem; transition: all 0.3s ease; border: 2px solid #00508f; font-size: 0.9rem;">
...
<div class="container" style="max-width: 1200px;">
        ...
        <div class="card-body p-3">
            <div class="d-flex align-items-center">
                <div class="icon-box me-3"
                     style="width: 45px; height: 45px; background: rgba(78,199,210,.3); border-radius: 10px;
        ...
        <div class="card-body p-3">
            ...
            <div class="d-flex flex-wrap gap-3 mb-4">
                <a href="{{ route('periodos-academicos.create') }}"
                   ...
                   style="background: linear-gradient(135deg,#004191 0%,#0b96b6 100%); color: white;
                          padding: 0.5rem 1rem; border-radius: 8px;
                          box-shadow: 0 2px 8px rgba(4,64,120,.12); text-decoration: none;">
                    ...
                    <tbody style="font-size: 0.9rem; color: #374151;">
                            ...
                            <td class="px-4 py-3 text-center">
                                <div class="d-flex justify-content-center gap-2">
                                    <a href="{{ route('periodos-academicos.edit', $periodo->id) }}"
                                       ...
                                       style="background: #4E8EA2; color: white; padding: 0.4rem 0.75rem;
                                              border-radius: 6px; text-decoration: none;
                                              box-shadow: 0 1px 6px rgba(63,124,145,.12);">
                                        <i class="fas fa-edit me-2"></i>Editar
                                    </a>
                                    <button type="button"
                                            class="btn btn-sm d-inline-flex align-items-center"
                                            data-route="{{ route('periodos-academicos.destroy', $periodo->id) }}"
                                            data-name="{{ $periodo->nombre_periodo }}"
                                            data-message="¿Estás seguro de que deseas eliminar este período académico?"
                                            onclick="mostrarModalDeleteData(this)"
                                            style="background: #6EA2B3; color: white; padding: 0.4rem 0.75rem;
                                                   border-radius: 6px; border: none;
                                                   box-shadow: 0 1px 6px rgba(90,144,161,.12);">
                        ...
                        <tr>
                            <td colspan="5" class="px-4 py-5 text-center"
                                style="color: #003b73; font-weight: 600; font-style: italic;">
    ...
    <div class="alert border-0 mt-3 py-2 px-3"
         style="border-radius: 8px; background: rgba(78,199,210,.08);
                border-left: 3px solid #4ec7d2; font-size: 0.85rem;">
...
@push('styles')
<style>
    .btn:hover { transform: translateY(-2px); transition: all 0.2s ease; }
