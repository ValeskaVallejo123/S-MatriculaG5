...
<section class="hero-section" id="inicio">
    ...
    <div class="container hero-content text-center">
        ...
        <div class="categories mt-4">
            <div class="category-tags d-flex justify-content-center flex-wrap gap-2">
                <a href="#matricula" class="category-tag text-decoration-none">Matrícula en Línea</a>
                <a href="{{ route('matriculas.index') }}" class="category-tag text-decoration-none">Consultar Solicitud</a>
                <a href="#nosotros" class="category-tag text-decoration-none">Sobre Nosotros</a>
                <a href="#contacto" class="category-tag text-decoration-none">Contacto</a>
            </div>
        </div>
    </div>
...
<section class="matricula-section py-5" id="matricula">
    <div class="container">
        <div class="text-center mb-5">
            <h2 class="fw-bold">Proceso de Matrícula 2025</h2>
            <p class="text-muted">Proceso sencillo, rápido y 100% en línea.</p>
        </div>

        <div class="row g-4">
            <div class="col-md-4">
                <div class="matricula-card h-100 p-4 shadow-sm border-0 rounded-4 bg-white">
                    <div class="matricula-card-icon mb-3 text-primary fs-1"><i class="fas fa-clipboard-list"></i></div>
                    <h3>Requisitos</h3>
            ...
            <div class="col-md-4">
                <div class="matricula-card h-100 p-4 shadow-sm border-0 rounded-4 bg-white">
                    <div class="matricula-card-icon mb-3 text-success fs-1"><i class="fas fa-file-signature"></i></div>
            ...
            <div class="col-md-4">
                <div class="matricula-card h-100 p-4 shadow-sm border-0 rounded-4 bg-white">
                    <div class="matricula-card-icon mb-3 text-warning fs-1"><i class="fas fa-calendar-check"></i></div>
        ...
        <div class="matricula-cta mt-5 p-5 bg-primary text-white rounded-4 text-center">
            <h3>¿Listo para Inscribir a tu Hijo(a)?</h3>
            <p class="mb-4">Completa el formulario y un miembro de nuestro equipo te contactará.</p>
            <a href="{{ route('matriculas.create') }}" class="btn btn-light btn-lg fw-bold rounded-pill px-5">
...
<section class="stats-section py-5 bg-primary text-white" id="nosotros">
    <div class="container">
        <div class="row g-4 text-center">
            ...
            <div class="col-md-3">
                <div class="stat-item">
                    ...
                    <p class="mb-0">Grados Escolares</p>
                </div>
            </div>
            <div class="col-md-3">
                <div class="stat-item">
...
<section class="cta-section py-5 text-center" id="contacto">
    <div class="container py-4">
        <h2 class="fw-bold mb-3">¿Listo para Formar Parte de Nuestra Familia?</h2>
        <p class="text-muted mb-4 mx-auto" style="max-width: 600px;">Únete a la comunidad educativa Gabriela Mistral hoy mismo.</p>
        <a href="{{ route('login') }}" class="btn btn-primary btn-lg rounded-pill px-5 shadow">
    ...
    <div class="container">
        <div class="row g-4">
            <div class="col-lg-3 col-md-6">
                <h4 class="mb-4 text-warning"><i class="fas fa-graduation-cap"></i> Gabriela Mistral</h4>
                <p class="small text-secondary">Comprometidos con la formación integral de nuestros estudiantes.</p>
            ...
            <div class="col-lg-3 col-md-6">
                ...
                <ul class="list-unstyled">
                    ...
                    <li><a href="#matricula" class="text-secondary text-decoration-none">Matrícula</a></li>
                    <li><a href="{{ route('matriculas.index') }}" class="text-secondary text-decoration-none">Consultar Solicitud</a></li>
                </ul>
            </div>
            <div class="col-lg-3 col-md-6">
                <h4 class="mb-4">Comunidad</h4>
                <ul class="list-unstyled text-secondary small">
                    <li>Portal Estudiantes</li>
                    <li>Portal Profesores</li>
                    <li>Portal Padres</li>
                </ul>
            </div>
            <div class="col-lg-3 col-md-6">
                <h4 class="mb-4">Contacto</h4>
                <p class="small text-secondary mb-1"><i class="fas fa-map-marker-alt me-2"></i> Danlí, Honduras</p>
                <p class="small text-secondary mb-1"><i class="fas fa-phone me-2"></i> +504 2763-4567</p>
                <p class="small text-secondary"><i class="fas fa-envelope me-2"></i> info@gabrielamistral.edu.hn</p>
            </div>
        </div>
        <hr class="my-4 border-secondary">
        <p class="text-center small text-secondary mb-0">&copy; 2025 Escuela Gabriela Mistral. Todos los derechos reservados.</p>
    </div>
</footer>
