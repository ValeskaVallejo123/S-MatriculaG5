...
<head>
    ...
    <style>
        ...
        .hero {
            ...
            url('{{ asset('imagenes/centroEd.jpg') }}');
...
<section class="hero">
    <div class="container">
        ...
        <div class="mt-4">
            ...
            <button class="btn btn-outline-light">Panel Administrativo</button>
        </div>
    </div>
</section>
...
<section class="mision-vision container my-5">
    <div class="row justify-content-center text-center">
        <div class="col-md-8 mb-4">
            ...
            <p>Somos una institución pionera responsable de formar y transformar a la niñez municipal,
                ...
                necesarias para adaptarse a la época de cambios que exige la sociedad y el mundo actual.</p>
        </div>
        <div class="col-md-8">
            <h3 class="fw-bold text-success">Visión</h3>
            <p>Ser una institución líder en la formación de la niñez Hondureña;
            ...
            <div class="col-md-6">
                <div class="contact-box">
                    ...
                    <div class="contact-info mt-3">
                        ...
                        <p><strong>Horarios de Atención:</strong><br>Lunes a Viernes: 7:00 AM - 4:00 PM<br></p>
                        <hr>
