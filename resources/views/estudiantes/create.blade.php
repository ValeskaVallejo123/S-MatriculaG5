    ...
    <div class="card border-0 shadow-sm mb-3"
        ...
        <div class="card-body p-3 d-flex align-items-center">
            ...
            <div class="text-white">
                <h5 class="mb-0 fw-bold">Registro de Estudiante</h5>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="position-relative">
                                ...
                                <input type="text" name="apellido1" id="apellido1"
                                       ...
                                       value="{{ old('apellido1') }}" placeholder="Ej: López" required
                                       style="border:2px solid #bfd9ea; border-radius:8px; padding:0.6rem 1rem 0.6rem 2.8rem;">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="position-relative">
                                ...
                                <select name="sexo" id="sexo"
                                        class="form-select ps-5 @error('sexo') is-invalid @enderror"
                                        required
                                        style="border:2px solid #bfd9ea; border-radius:8px; padding:0.6rem 1rem 0.6rem 2.8rem;">
...
<div class="col-md-6">
    ...
    <div class="position-relative">
        ...
        <input type="email"
               ...
               name="email"
               value="{{ old('email') }}"
               placeholder="Se generará como nombre.apellido@egm.edu.hn"
               readonly
               style="border: 2px solid #bfd9ea; border-radius: 8px; padding: 0.6rem 1rem 0.6rem 2.8rem; transition: all 0.3s ease; background-color: #f9fafb;">
        @error('email')
        ...
        <small class="text-muted" style="font-size: 0.75rem;">
            Se genera automáticamente usando: primerNombre.apellido@egm.edu.hn
        </small>
    </div>
</div>
                ...
                <div class="mb-3">
                    <h6 class="mb-2 pb-2 border-bottom d-flex align-items-center"
                        style="color:#00508f; font-weight:600;">
                    ...
                    <div class="row g-2">
                        ...
                        <!-- Grado -->
                        <div class="col-md-4">
                            <label class="form-label fw-semibold small mb-1">Grado <span class="text-danger">*</span></label>
                            <select name="grado" class="form-select form-select-sm @error('grado') is-invalid @enderror" required>
                                <option value="">Seleccione</option>
                        ...
                        <!-- Sección -->
                        <div class="col-md-4">
                            <label class="form-label fw-semibold small mb-1">Sección <span class="text-danger">*</span></label>
                            <select name="seccion" class="form-select form-select-sm @error('seccion') is-invalid @enderror" required>
                                <option value="">Seleccione</option>
                        ...
                        <!-- Estado -->
                        <div class="col-md-4">
                            <label class="form-label fw-semibold small mb-1">Estado <span class="text-danger">*</span></label>
                            <select name="estado" class="form-select form-select-sm @error('estado') is-invalid @enderror" required>
                    ...
                    <div class="row g-2">
                        <div class="col-12">
                            ...
                            <textarea name="observaciones" rows="2" maxlength="500"
                                      ...
                                      placeholder="Información adicional (alergias, condiciones médicas, notas, etc.)"
...
<div class="mb-4">
    ...
    <div class="alert border-0 mt-2 py-2 px-3"
         style="border-radius:8px; background:rgba(78,199,210,0.1); border-left:3px solid #4ec7d2;">
        <div class="d-flex align-items-start">
            <i class="fas fa-info-circle me-2 mt-1" style="color:#00508f;"></i>
            <div>
                <strong style="color:#00508f;">Información importante:</strong>
                <span class="text-muted">Verifique todos los datos antes de guardar. El DNI debe ser único.</span>
            </div>
        </div>
    </div>
