                        ...
                        <div class="col-md-6">
                            ...
                            <div class="position-relative">
                                <i class="fas fa-id-card position-absolute"
                                   style="left:12px; top:50%; transform:translateY(-50%); color:#00508f; font-size:0.85rem;"></i>
                                <input type="text" id="dni" name="dni" maxlength="13"
                                       class="form-control ps-5 @error('dni') is-invalid @enderror"
                                       value="{{ old('dni') }}" placeholder="Ej: 0801199512345"
                                       style="border:2px solid #bfd9ea; border-radius:8px; padding:0.6rem 1rem 0.6rem 2.8rem; transition:all 0.3s ease;">
                                @error('dni')
                                    <div class="invalid-feedback" style="font-size:0.8rem;">
                                        <i class="fas fa-exclamation-circle me-1"></i>{{ $message }}
                            ...
                            <div class="position-relative">
                                ...
                                <input type="email" id="email" name="email"
                                       ...
                                       style="border:2px solid #bfd9ea; border-radius:8px; padding:0.6rem 1rem 0.6rem 2.8rem;
                                              transition:all 0.3s ease; background-color:#f9fafb;">
                                @error('email')
                                    <div class="invalid-feedback" style="font-size:0.8rem;">
                                        <i class="fas fa-exclamation-circle me-1"></i>{{ $message }}
                                    </div>
                                ...
                                <small class="text-muted" style="font-size:0.75rem;">
                                    Se genera automáticamente: primerNombre.primerApellido@egm.edu.hn
                                </small>
                            </div>
                        </div>
