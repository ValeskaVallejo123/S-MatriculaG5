...
<style>
    ...
    .est-tbl { width: 100%; border-collapse: collapse; min-width: 700px; }
    .est-tbl thead th {
    ...
    /* Columna acciones con ancho fijo suficiente para 4 botones */
    .col-acciones { width: 130px; min-width: 130px; }
    ...
    .est-av img { width: 100%; height: 100%; object-fit: cover; border-radius: 7px; }
    .est-name  { font-weight: 600; color: var(--blue-dark); font-size: .85rem; }
    .est-email { font-size: .71rem; color: var(--text-muted); margin-top: .1rem; }
    ...
    .act-historial { border-color: #7c3aed;         color: #7c3aed; }
    ...
    .act-historial:hover { background: #7c3aed;         color: white; }
    ...
    @media(max-width: 768px) {
        ...
        .est-tbl thead th, .est-tbl tbody td { padding: .5rem .45rem; font-size: .74rem; }
    }
    @media(max-width: 480px) {
        ...
        .est-name  { font-size: .76rem; }
        .est-email { font-size: .67rem; }
    }
</style>
@endpush
    ...
    <div class="est-toolbar">
        ...
        <div class="est-perpage">
            <label for="perPageSelect">
                <i class="fas fa-list-ol" style="color:#4ec7d2;"></i> Mostrar:
            </label>
            ...
            <table class="est-tbl" id="studentsTable">
                <thead>
                    <tr>
                        ...
                        <th>Nombre</th>
                        <th>DNI</th>
                        <th class="tc" style="width:110px;">Grado</th>
                        <th class="tc" style="width:70px;">Sección</th>
                ...
                <tbody id="tableBody">
                    ...
                    <tr class="student-row"
                        ...
                        {{-- Acciones — 4 botones siempre visibles y completos --}}
                        ...
                        <tr>
                            <td colspan="8">
                                <div class="est-empty">
                                    ...
                                    <a href="{{ route('estudiantes.create') }}" class="est-topbar-btn" style="display:inline-flex;">
