            ...
            <div class="bg-white rounded-lg shadow-sm px-5 py-4 border border-gray-200">
                <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
                    ...
                    <form action="{{ route('estudiantes.index') }}" method="GET" class="flex gap-2 w-full lg:w-auto lg:max-w-md">
                        ...
                        <a href="{{ route('registroestudiantes.buscarregistro') }}"
                           class="inline-flex items-center gap-2 px-4 py-2 bg-green-600 text-white text-sm font-semibold rounded-lg shadow hover:bg-green-700 transition duration-300 ease-in-out transform hover:scale-105">
