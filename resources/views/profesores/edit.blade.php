...
@section('topbar-actions')
    <a href="{{ route('profesores.index') }}" class="btn-back" style="background: white; color: #00508f; padding: 0.5rem 1.2rem; border-radius: 8px; text-decoration: none; font-weight: 600; display: inline-flex; align-items: center; gap: 0.5rem; border: 2px solid #4ec7d2; font-size: 0.9rem;">
...
<style>
    ...
    .invalid-feedback { display: block; margin-top: 0.35rem; }
    ...
    <div class="card border-0 shadow-sm mb-3" style="border-radius: 12px; background: linear-gradient(135deg, rgba(78,199,210,0.1) 0%, rgba(0,80,143,0.05) 100%);">
        <div class="card-body p-3">
            <div class="d-flex align-items-center gap-3">
                <div style="width:50px;height:50px;background:linear-gradient(135deg,#00508f,#003b73);border-radius:12px;display:flex;align-items:center;justify-content:center;border:3px solid #4ec7d2;">
                ...
                <div>
                    ...
                    <div class="d-flex flex-wrap gap-2">
                        @if($profesor->email)
                            <span class="badge" style="background:rgba(78,199,210,0.2);color:#00508f;border:1px solid #4ec7d2;font-size:0.75rem;">
                                <i class="fas fa-envelope me-1"></i>{{ $profesor->email }}
                            </span>
                        @endif
                        @if($profesor->especialidad)
                            <span class="badge" style="background:rgba(0,80,143,0.15);color:#003b73;border:1px solid #00508f;font-size:0.75rem;">
            ...
            <form action="{{ route('profesores.update', $profesor) }}" method="POST">
                ...
                <div class="mb-4">
                    <div class="d-flex align-items-center gap-2 mb-3">
                        <div style="width:36px;height:36px;background:linear-gradient(135deg,#4ec7d2,#00508f);border-radius:8px;display:flex;align-items:center;justify-content:center;">
                            <i class="fas fa-user" style="color:white;font-size:0.9rem;"></i>
                        </div>
                        <h6 class="mb-0 fw-bold" style="color:#003b73;">Información Personal</h6>
                    </div>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="position-relative">
                                ...
                                <input type="text"
                                       ...
                                       style="border:2px solid #bfd9ea;border-radius:8px;padding:0.6rem 1rem 0.6rem 2.8rem;">
                                @error('nombre')
                        ...
                        <div class="col-md-6">
                            ...
                            <small class="text-muted" style="font-size:0.75rem;"><i class="fas fa-info-circle me-1"></i>Formato: 13 dígitos</small>
                        </div>

                        {{-- Fecha de Nacimiento --}}
                        <div class="col-md-6">
                            <label for="fecha_nacimiento" class="form-label small fw-semibold" style="color:#003b73;">Fecha de Nacimiento</label>
                            <div class="position-relative">
                        ...
                        {{-- Género --}}
                        <div class="col-md-6">
                            <label for="genero" class="form-label small fw-semibold" style="color:#003b73;">Género</label>
                            <div class="position-relative">
                        ...
                        {{-- Teléfono --}}
                        <div class="col-md-6">
                            <label for="telefono" class="form-label small fw-semibold" style="color:#003b73;">Teléfono</label>
                            <div class="position-relative">
                ...
                <div class="mb-4">
                    <div class="d-flex align-items-center gap-2 mb-3">
                        ...
                        <h6 class="mb-0 fw-bold" style="color:#003b73;">Información de Contacto</h6>
                    </div>
                    ...
                    <div class="row g-3">
                        ...
                        {{-- Dirección --}}
                        <div class="col-md-6">
                            <label for="direccion" class="form-label small fw-semibold" style="color:#003b73;">Dirección</label>
                            <div class="position-relative">
                ...
                <div class="mb-4">
                    <div class="d-flex align-items-center gap-2 mb-3">
                        ...
                        <h6 class="mb-0 fw-bold" style="color:#003b73;">Información Académica</h6>
                    </div>
                    ...
                    <div class="row g-3">
                        ...
                        {{-- Nivel Académico --}}
                        <div class="col-md-6">
                            <label for="nivel_academico" class="form-label small fw-semibold" style="color:#003b73;">Nivel Académico</label>
                            <div class="position-relative">
                ...
                <div class="mb-4">
                    <div class="d-flex align-items-center gap-2 mb-3">
                        ...
                        <h6 class="mb-0 fw-bold" style="color:#003b73;">Información Laboral</h6>
                    </div>

                    <div class="row g-3">
                        {{-- Fecha de Contratación --}}
                        <div class="col-md-6">
                            <label for="fecha_contratacion" class="form-label small fw-semibold" style="color:#003b73;">Fecha de Contratación</label>
                            <div class="position-relative">
                        ...
                        {{-- Tipo de Contrato --}}
                        <div class="col-md-6">
                            <label for="tipo_contrato" class="form-label small fw-semibold" style="color:#003b73;">Tipo de Contrato</label>
                            <div class="position-relative">
                ...
                <div class="d-flex justify-content-end gap-2 pt-3 border-top">
                    <a href="{{ route('profesores.index') }}" class="btn" style="border:2px solid #00508f;color:#00508f;background:white;padding:0.6rem 1.5rem;border-radius:8px;font-weight:600;">
                        <i class="fas fa-times me-1"></i>Cancelar
                    </a>
                    <button type="submit" class="btn" style="background:linear-gradient(135deg,#4ec7d2,#00508f);color:white;border:none;padding:0.6rem 1.5rem;border-radius:8px;font-weight:600;box-shadow:0 2px 8px rgba(78,199,210,0.3);">
