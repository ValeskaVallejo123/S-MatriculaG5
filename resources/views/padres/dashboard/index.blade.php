...
<div class="container" style="max-width: 1200px;">
        ...
        <div class="card-body p-4">
            <div class="row align-items-center">
                ...
                <div class="col">
                    ...
                    <p class="text-muted mb-0">Portal de información de sus hijos</p>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-grow-1 ms-3">
                            <h6 class="text-muted mb-1 small">Hijos Vinculados</h6>
        ...
        <div class="col-md-4">
            <div class="card border-0 shadow-sm h-100" style="border-radius: 10px; border-left: 4px solid #00508f;">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div class="flex-shrink-0">
                            <i class="fas fa-file-invoice fa-2x" style="color: #00508f;"></i>
                        </div>
                        <div class="flex-grow-1 ms-3">
                            <h6 class="text-muted mb-1 small">Reportes</h6>
                            <h3 class="mb-0 fw-bold" style="color: #003b73;">-</h3>
                        </div>
                    </div>
                </div>
    ...
    <div class="card border-0 shadow-sm" style="border-radius: 12px;">
        <div class="card-body text-center py-5">
            ...
            <p class="text-muted mb-0">Pronto podrá ver las calificaciones, asistencia y más información de sus hijos.</p>
        </div>
    </div>
