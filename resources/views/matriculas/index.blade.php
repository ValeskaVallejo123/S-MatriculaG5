...
.act-btn {
    ...
    cursor: pointer; font-size: .72rem; text-decoration: none;
    transition: all .15s;
}
                    ...
                    <tr>
                        ...
                        <td>
                            <div style="display:flex;align-items:center;gap:.65rem;">
                                <div class="mat-av">
                                    {{ strtoupper(
                                        substr($matricula->estudiante->nombre1   ?? $matricula->estudiante->nombre   ?? 'N', 0, 1) .
                                        substr($matricula->estudiante->apellido1 ?? $matricula->estudiante->apellido ?? 'A', 0, 1)
                                    ) }}
                                </div>
                                <div>
                                    <div class="mat-name">
                        ...
                        {{-- Grado / Sección --}}
                        <td class="tc">
                            <span class="bpill b-cyan" style="margin-right:.3rem;">{{ $matricula->estudiante->grado ?? 'N/A' }}</span>
                        ...
                        <td class="tc">
                            ...
                            @elseif($matricula->estado === 'pendiente')
                                <form action="{{ route('matriculas.aprobar', $matricula->id) }}" method="POST" style="display:inline;">
                                    @csrf
                                    @method('PATCH')
