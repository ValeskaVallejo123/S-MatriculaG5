...
@push('styles')
    <style>
        ...
        .pd-stat-num { font-size: 1.75rem; font-weight: 800; color: var(--text-main); line-height: 1; }
        ...
        .pd-banner h6    { font-size: .85rem; font-weight: 700; color: var(--text-main); margin: 0 0 .2rem; }
        .pd-banner p     { font-size: .78rem; color: var(--muted); margin: 0; }

        /* Especial para Dark Mode en paneles */
        body.dark-mode .pd-panel-head { background: rgba(255,255,255,0.05); }
    ...
    <div class="pd-wrap">
        ...
        <div class="d-flex justify-content-end mb-3">
            <button id="darkModeToggle" class="btn btn-sm shadow-sm fw-bold d-flex align-items-center gap-2"
                    style="border-radius: 50px; background: #003b73; color: white; padding: 5px 15px; border: none; transition: all 0.3s ease;">
