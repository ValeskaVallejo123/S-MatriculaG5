...
<div class="container" style="max-width: 1200px;">
    ...
    <div class="card border-0 shadow-sm mb-4" style="border-radius: 12px; background: linear-gradient(135deg, rgba(78,199,210,.15) 0%, rgba(0,80,143,.1) 100%);">
        <div class="card-body p-4">
            <div class="row align-items-center">
                <div class="col-auto">
                    <div style="width:70px;height:70px;background:linear-gradient(135deg,#00508f,#003b73);border-radius:16px;display:flex;align-items:center;justify-content:center;border:3px solid #4ec7d2;">
    ...
    <div class="row g-3 mb-4">
            ...
            <div class="card border-0 shadow-sm h-100" style="border-radius:10px;border-left:4px solid #4ec7d2;">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <i class="fas fa-users fa-2x me-3" style="color:#4ec7d2;"></i>
                        <div>
        ...
        <div class="col-md-4">
            <div class="card border-0 shadow-sm h-100" style="border-radius:10px;border-left:4px solid #00508f;">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <i class="fas fa-book fa-2x me-3" style="color:#00508f;"></i>
                        <div>
        ...
        <div class="col-md-4">
            <div class="card border-0 shadow-sm h-100" style="border-radius:10px;border-left:4px solid #003b73;">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <i class="fas fa-clipboard-list fa-2x me-3" style="color:#003b73;"></i>
                        <div>
            ...
            <div class="row g-3">
                <div class="col-md-3">
                    <a href="#" class="text-decoration-none">
                        <div class="card border-0 h-100" style="background:linear-gradient(135deg,#4ec7d2,#00508f);border-radius:10px;">
                            <div class="card-body text-center p-3">
                                <i class="fas fa-users" style="font-size:2rem;color:white;margin-bottom:.5rem;"></i>
                ...
                <div class="col-md-3">
                    <a href="#" class="text-decoration-none">
                        <div class="card border-0 h-100" style="background:linear-gradient(135deg,#00508f,#003b73);border-radius:10px;">
                            <div class="card-body text-center p-3">
                                <i class="fas fa-book" style="font-size:2rem;color:white;margin-bottom:.5rem;"></i>
                ...
                <div class="col-md-3">
                    <a href="#" class="text-decoration-none">
                        <div class="card border-0 h-100" style="background:linear-gradient(135deg,#003b73,#00508f);border-radius:10px;">
                            <div class="card-body text-center p-3">
                                <i class="fas fa-clipboard-check" style="font-size:2rem;color:white;margin-bottom:.5rem;"></i>
                ...
                <div class="col-md-3">
                    <a href="#" class="text-decoration-none">
                        <div class="card border-0 h-100" style="background:linear-gradient(135deg,#00508f,#4ec7d2);border-radius:10px;">
                            <div class="card-body text-center p-3">
                                <i class="fas fa-calendar-alt" style="font-size:2rem;color:white;margin-bottom:.5rem;"></i>
            ...
            <div class="card border-0 shadow-sm h-100" style="border-radius:12px;">
                <div class="card-body p-4">
                    ...
                    <div class="text-center py-4">
                        <i class="fas fa-inbox fa-2x mb-2" style="color:#4ec7d2;opacity:.5;"></i>
        ...
        <div class="col-md-6">
            <div class="card border-0 shadow-sm h-100" style="border-radius:12px;">
                <div class="card-body p-4">
                    ...
                    <div class="text-center py-4">
                        <i class="fas fa-calendar fa-2x mb-2" style="color:#4ec7d2;opacity:.5;"></i>
