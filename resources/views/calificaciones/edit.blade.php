...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-3xl mx-auto">
        <h1 class="text-3xl font-bold text-gray-800 mb-6">Editar Calificación</h1>
            ...
            <form action="{{ route('calificaciones.update', $calificacion) }}" method="POST">
                ...
                <div class="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
                    <p class="text-sm text-blue-800">
                        <strong>Nota:</strong> La nota final se recalculará automáticamente al guardar los cambios.
                    </p>
                </div>
