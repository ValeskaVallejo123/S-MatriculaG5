...
.e-codigo-wrap .e-input {
    ...
    color: #00508f; letter-spacing: .05em;
}
.e-codigo-btn {
...
<div class="edit-wrap">
    ...
    <form action="{{ route('materias.store') }}" method="POST" id="formCrear">
        @csrf
        ...
        <div class="e-card">
            ...
            <div class="e-card-body">
                ...
                <div class="e-grid" style="margin-bottom:1.25rem;">
                    ...
                    <div class="e-field">
                        ...
                        <select name="nivel" class="e-select @error('nivel') is-invalid @enderror"
                            ...
                            <option value="primaria"   {{ old('nivel') == 'primaria'   ? 'selected' : '' }}>Primaria (1° - 6°)</option>
                            <option value="secundaria" {{ old('nivel') == 'secundaria' ? 'selected' : '' }}>Secundaria (7° - 9°)</option>
                        </select>
                    ...
                    <div class="e-field">
                        ...
                        <span class="e-hint">Click en <i class="fas fa-sync-alt"></i> para generar automaticamente</span>
                    </div>
                    ...
                    <div class="e-field">
                        ...
                        <div class="e-toggle-wrap" style="margin-top:.25rem;">
                            <button type="button" class="e-toggle on"
                                    id="toggleActivo" onclick="toggleEstado()"></button>
                            <span class="e-toggle-lbl" id="toggleLbl">Activa</span>
                ...
                <div class="areas-grid" id="areasGrid">
                    <p style="color:#94a3b8;font-size:.8rem;grid-column:1/-1;">
                        Selecciona un nivel para ver las areas disponibles.
                    </p>
                </div>
                ...
                <div class="e-field">
                    <textarea name="descripcion"
                              ...
                              placeholder="Descripcion breve de los objetivos de la materia...">{{ old('descripcion') }}</textarea>
