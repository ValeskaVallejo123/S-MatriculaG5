    ...
    <div class="card border-0 shadow-sm mb-4"
        ...
        <div class="card-body p-4">
            <div class="d-flex align-items-center gap-3">
                <div style="width:65px;height:65px;background:linear-gradient(135deg,#00508f 0%,#003b73 100%);border-radius:14px;display:flex;align-items:center;justify-content:center;border:3px solid #4ec7d2;">
                    <i class="fas fa-user-shield" style="font-size:1.8rem;color:white;"></i>
                </div>
                <div>
