...
<<<<<<< HEAD
                <div class="col-md-6 col-lg-4 col-xl-3 grado-card" data-nivel="{{ $grado->nivel }}" data-grado="{{ $grado->numero }}" data-seccion="{{ $grado->seccion }}" data-anio="{{ $grado->anio_lectivo }}">
                ...
                <div class="col-12">
                    <div class="card border-0 shadow-sm" style="border-radius: 12px;">
                        <div class="card-body text-center py-5">
                            ...
                            <a href="{{ route('grados.create') }}" style="background: linear-gradient(135deg, #4ec7d2 0%, #00508f 100%); color: white; border-radius: 8px; padding: 0.6rem 1.5rem; text-decoration: none; font-weight: 600; display: inline-flex; align-items: center; gap: 0.5rem;">
                ...
                <div class="col-md-6 col-lg-4 col-xl-3">
                    <div class="card border-0 shadow-sm h-100" style="border-radius: 12px; border-left: 4px solid #4ec7d2;">
                        <div class="card-body p-4">
                            ...
                            <div class="d-flex gap-2">
                                <a href="{{ route('grados.show', $grado) }}" class="btn btn-sm flex-fill btn-grado-view" style="border: 2px solid #6366f1; color: #6366f1; background: white; border-radius: 8px; font-size: 0.875rem; font-weight: 600;"><i class="fas fa-eye"></i></a>
                                <a href="{{ route('grados.asignar-materias', $grado) }}" class="btn btn-sm flex-fill btn-grado-materias" style="border: 2px solid #4ec7d2; color: #4ec7d2; background: white; border-radius: 8px; font-size: 0.875rem; font-weight: 600;"><i class="fas fa-tasks"></i></a>
                                <a href="{{ route('grados.edit', $grado) }}" class="btn btn-sm btn-grado-edit" style="border: 2px solid #f59e0b; color: #f59e0b; background: white; border-radius: 8px; font-size: 0.875rem; font-weight: 600;"><i class="fas fa-edit"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
...
<style>
    ...
    .btn-grado-view:hover {
        background: #6366f1 !important;
        color: white !important;
        transform: translateY(-2px);
    }

    .btn-grado-materias:hover {
        background: #4ec7d2 !important;
        color: white !important;
        transform: translateY(-2px);
    }

    .btn-grado-edit:hover {
    ...
    .nav-tabs .nav-link:hover:not(.active) {
        background: linear-gradient(135deg, rgba(78, 199, 210, 0.1) 0%, rgba(0, 80, 143, 0.1) 100%);
    }
