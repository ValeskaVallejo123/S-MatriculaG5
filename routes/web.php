...
Route::middleware(['auth'])->group(function () {
    ...
    */
    ...
    /*
    |----------------------------------------------------------------------
    | ACCIONES IMPORTANTES (auth general)
    |----------------------------------------------------------------------
    */
    ...
    */
    ...
    /*
    |----------------------------------------------------------------------
    | PROFESORES (CRUD — solo admin/super_admin)
    |----------------------------------------------------------------------
    */
    ...
    */
    ...
    /*
    |----------------------------------------------------------------------
    | PANEL DE ADMINISTRADORES (gestión interna)
    |----------------------------------------------------------------------
    */
