...
// Nuevas páginas públicas del main
...
Route::middleware(['auth'])->group(function () {
    ...
    */
    ...
    |-------------------------------------------------------------------------
    */
    Route::resource('cupos_maximos', \App\Http\Controllers\CupoMaximoController::class);
    ...
    */
    ...
    /*
 |----------------------------------------------------------------------
 | ESTUDIANTE (Lo que ve el alumno logueado)
 |----------------------------------------------------------------------
 */
    Route::prefix('estudiante')->name('estudiante.')->group(function () {
        ...
        // Cambiamos el controlador al nuevo HistorialController
        // Usamos Auth::id() para que el estudiante siempre caiga en SU propio ID
        Route::get('/mi-historial', function() {
            return (new \App\Http\Controllers\HistorialController)->showHistorial(auth()->id());
        })->name('historial');
