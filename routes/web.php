...
Route::middleware(['auth'])->group(function () {
    ...
    */
    Route::prefix('superadmin')->name('superadmin.')->group(function () {
        ...
        Route::resource('administradores', SuperAdminController::class)->names([
    ...
    */
    Route::prefix('matriculas')->name('matriculas.')->group(function () {
        Route::resource('/', MatriculaController::class)->parameters(['' => 'matricula']);
    });
    ...
    */
    Route::prefix('cupos_maximos')->name('cupos_maximos.')->group(function () {
        Route::resource('/', CursoController::class)->parameters(['' => 'id']);
    });
    ...
    */
    ...
    |--------------------------------------------------------------------------
    */
    // LISTA DE GRADOS PARA VER / EDITAR HORARIOS
    Route::get('horarios-grado', [HorarioGradoController::class, 'index'])
        ->name('horarios_grado.index');

    // MOSTRAR HORARIO
    Route::get('horarios-grado/{grado}/{jornada?}/show', [HorarioGradoController::class, 'show'])
        ->name('horarios_grado.show');

    // EDITAR HORARIO (CUADRÍCULA)
    Route::get('horarios-grado/{grado}/{jornada?}/edit', [HorarioGradoController::class, 'edit'])
        ->name('horarios_grado.edit');

    // GUARDAR CAMBIOS
    Route::post('horarios-grado/{grado}/{jornada?}/update', [HorarioGradoController::class, 'update'])
        ->name('horarios_grado.update');

    // DESCARGAR PDF
    Route::get('horarios-grado/{grado}/{jornada?}/pdf', [HorarioGradoController::class, 'pdf'])
