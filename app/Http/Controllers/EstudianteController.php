...
class EstudianteController extends Controller
{
    ...
    private function reglasValidacion(?int $estudianteId = null): array
    {
        ...
        return [
            ...
            // Antes: 'max:2048' (2 MB) -> Ahora: 'max:10240' (10 MB)
    ...
    private function mensajesValidacion(): array
    {
        return [
            ...
            // Antes: 'La foto no puede superar los 2 MB.' -> Ahora: 10 MB
    ...
    {
        // Antes: 'max:5120' (5 MB) -> Ahora: 'max:20480' (20 MB)
        $reglas = array_merge($this->reglasValidacion(), [
            'acta_nacimiento' => ['required', 'file', 'mimes:jpg,jpeg,png,pdf', 'max:20480'],
            'calificaciones'  => ['required', 'file', 'mimes:jpg,jpeg,png,pdf', 'max:20480'],
        ]);

        $mensajes = array_merge($this->mensajesValidacion(), [
            'acta_nacimiento.required' => 'El acta de nacimiento es obligatoria.',
            // Antes: 'no puede superar los 5 MB.' -> Ahora: 20 MB
            'acta_nacimiento.max'      => 'El acta de nacimiento no puede superar los 20 MB.',
            'calificaciones.required'  => 'Las calificaciones anteriores son obligatorias.',
            'calificaciones.max'       => 'Las calificaciones no pueden superar los 20 MB.',
        ]);
