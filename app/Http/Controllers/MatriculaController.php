...
{
    $grados      = GradoHelper::GRADOS; // ← ya normalizado: '1er Grado', etc.
    $secciones   = ['A', 'B', 'C', 'D'];
    $parentescos = [
        'padre'   => 'Padre',
        'madre'   => 'Madre',
    ...
    public function edit(Matricula $matricula)
{
    ...
    $grados      = self::GRADOS;
    $secciones   = ['A', 'B', 'C', 'D'];        // ← línea que faltaba
    $parentescos = [
        'padre'   => 'Padre',
        'madre'   => 'Madre',
        'abuelo'  => 'Abuelo/a',
    ...
    return view('matriculas.edit', compact(
        'matricula', 'estudiantes', 'padres', 'parentescos', 'grados', 'secciones'  // ← agregar 'secciones'
    ));
}
